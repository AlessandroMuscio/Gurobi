...
public class App2 {
  ...
  // Variabili di Gurobi
  /**
   * Variabile che rappresenta l'ambiente del problema
   */
  ...
  public static void main(String[] args) {
    try {
      ...
      GRBModel modello = new GRBModel(ambiente); // Creo un modello vuoto utilizzando l'ambiente precedentemente creato
   ...
   */
  private static void inizializzaVariabili(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static void impostaFunzioneObiettivo(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static void impostaVincoliDiModulo(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static void impostaVincoliDiCopertura(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static void impostaVincoliDiCosto(GRBModel modello) throws GRBException {
    for (int i = 0; i < M; i++) {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static void impostaVincoliDiBilancio(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static void impostaVincoliDiTempo(GRBModel modello) throws GRBException {
    for (int j = 0; j < K; j++) {
      for (int i = 0; i < M; i++) {
  ...
  private static void calcolaEStampa(GRBModel modello) throws GRBException {
    modello.update();
    modello.optimize();
    ...
    System.out.println("\nQUESITO II:");
    System.out.println("variabili in base: " + ottieniVariabiliInBase(modello));
    System.out.println("coefficienti di costo ridotto: " + costoRidotto(modello));
    System.out.println("soluzione ottima multipla: " + soluzioneMultipla(modello));
    System.out.println("soluzione ottima degenere: " + soluzioneDegenere(modello));
    System.out.println("vincoli vertice ottimo:" + vincoliVerticeOttimo(modello));
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static String ottieniValoreFunzioneObbiettivo(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static String calcolaCoperturaRaggiuntaTotale(GRBModel modello) throws GRBException {
    int i = 0, j = 0;
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static String calcolaTempoAcquistato(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static String calcolaBilancioInutilizzato(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  private static String ottieniSoluzioneDiBaseOttima(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  public static String ottieniVariabiliInBase(GRBModel modello) throws GRBException {
   ...
   * @throws GRBException Eccezione di Gurobi, lanciata quando qualcosa va storto
   */
  public static String costoRidotto(GRBModel modello) throws GRBException {
  ...
  public static String soluzioneMultipla(GRBModel modello) throws GRBException {

    int count = 0;
    boolean multipla = false;
    int[] base = ottieniVariabiliBaseInt(modello);
  ...
  public static String soluzioneDegenere(GRBModel modello) throws GRBException {

    int count = 0;
    boolean degenere = false;
    int[] var_in_base = ottieniVariabiliBaseInt(modello);
  ...
  public static String vincoliVerticeOttimo(GRBModel modello) throws GRBException {
    ...
    return vincoliVerticeOttimo.toString();
  }

  public static String[] ottieniVariabiliBase(GRBModel modello) throws GRBException {
  ...
  public static int[] ottieniVariabiliBaseInt(GRBModel modello) throws GRBException {
...
/*  public static void quesito3(GRBModel modello) throws GRBException {
    ...
    impostaFunzioneObiettivo(modello1);

    GRBLinExpr vincoloDiModulo0 = new GRBLinExpr();
    GRBLinExpr vincoloDiModulo1 = new GRBLinExpr();
    GRBLinExpr vincoloFasullo = new GRBLinExpr();
    ...
    modello1.addConstr(vincoloDiModulo0, GRB.LESS_EQUAL, a, "Vincolo_di_modulo_0");
    modello1.addConstr(vincoloDiModulo1, GRB.LESS_EQUAL, a, "Vincolo_di_modulo_1");

    vincoloFasullo.addTerm(1, s[0]);
    modello1.addConstr(vincoloDiModulo1, GRB.EQUAL, 100, "vincolo_fasullo");

    impostaVincoliDiCopertura(modello1);
    ...
    for (GRBVar x : modello.getVars()) {
      ...
      s1.append(String.format("%s = %.4f ", nome, valore));
    }

    System.out.println(s1);

    int count = modello.get(GRB.IntAttr.SolCount);
    count--;
...
//    modello.set();
    ...
    // --VALORIZZO UNA SLACK DI UN VINCOLO CHE DETERMINA IL VERTICE OTTIMO MAGGIORE DI ZERO--
    GRBLinExpr vincoloFasullo = new GRBLinExpr();

    // utilizzo s[0] perchè corrisponde al vincolo di modulo che determina il vertice ottimo
    vincoloFasullo.addTerm(1, s[0]);
    modello.addConstr(vincoloFasullo, GRB.EQUAL, 100, "vincolo_fasullo");
    modello.update();
    modello.optimize();
    ...
    for (GRBVar x : modello.getVars()) {
      ...
      s3.append(String.format("%s = %.4f ", nome, valore));
    }
